...
extern void launch_scalar_field_point_kernel(dim3 blockSize, dim3 gridSize,
		std::vector<float>& points, std::vector<float>& vfield, std::vector<foc::Point3i>& batch_offsets,
